...
- **Hero**: Senior Agentic AI Engineer intro.
...
_This recording demonstrates the "shrink behind" effect as sections stack at the top of the viewport._
...
> [!TIP]
> Each section is wrapped in a `relative h-screen` container that provides the "scroll room" required to trigger the sticky behavior and the transformation of the _previous_ section.
