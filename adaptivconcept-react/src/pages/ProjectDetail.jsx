    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[24px] md:rounded-[40px] overflow-hidden relative group aspect-video lg:aspect-auto lg:h-[500px]">
        ...
        <div className="lg:col-span-5">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[24px] md:rounded-[40px] p-6 md:p-10 h-full flex flex-col group relative overflow-hidden">
            {/* Ambient subtle glow */}
        ...
        <div className="lg:col-span-12">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[24px] md:rounded-[40px] p-6 md:p-16">
            ...
            <div className="max-w-4xl text-gray-400 leading-[2] text-base md:text-lg font-poppins">
              <p className="mb-10 first-letter:text-4xl md:first-letter:text-5xl first-letter:font-bold first-letter:text-adaptiv-orange first-letter:mr-3 first-letter:float-left">
