  ...
  if (!project) {
    return (
      <div className="container mx-auto px-6 py-20 text-center min-h-screen flex flex-col items-center justify-center">
        <h2 className="text-4xl font-comfortaa font-bold text-white mb-6">Project Not Found</h2>
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[40px] overflow-hidden relative group aspect-video lg:aspect-auto lg:h-[500px]">
            <div className="w-full h-full flex flex-col items-center justify-center bg-black/40">
              <div className="text-center">
                 ...
                 <h2 className="text-3xl font-comfortaa font-bold text-white/50">{project.title}</h2>
              </div>
            </div>
        ...
        <div className="lg:col-span-5">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[40px] p-10 h-full flex flex-col group relative overflow-hidden">
            {/* Ambient subtle glow */}
            ...
            <h1 className="text-4xl md:text-5xl font-comfortaa font-bold text-white mb-8 leading-tight">
              {project.title}
            </h1>
            
            <p className="text-lg text-gray-400 font-poppins mb-10 leading-relaxed">
              {project.description}
            </p>
            ...
            <div className="space-y-4 mt-auto">
              <div className="flex flex-wrap gap-4 mb-6">
                <a 
                  ...
                  className="flex-grow py-4 rounded-2xl bg-adaptiv-orange text-white font-bold flex items-center justify-center gap-3 hover:bg-white hover:text-adaptiv-orange transition-all shadow-lg shadow-adaptiv-orange/10"
                >
                  <i className="bi bi-github text-xl"></i> View Repository
                </a>
                <a 
                  href="#" 
                  className="px-6 py-4 rounded-2xl bg-white/5 border border-white/10 text-white font-bold flex items-center justify-center gap-3 hover:bg-white/10 transition-all"
                >
                  <Globe size={20} /> Project Link
                </a>
              </div>
              <button className="w-full py-4 rounded-2xl border border-white/5 bg-white/5 text-gray-400 font-bold hover:bg-white/10 hover:text-white transition-all">
        ...
        <div className="lg:col-span-12">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[40px] p-10 md:p-16">
            <div className="flex items-center gap-4 mb-8">
              <div className="w-12 h-12 rounded-2xl bg-adaptiv-orange/10 flex items-center justify-center text-adaptiv-orange">
                <Info size={28} />
              </div>
              <h3 className="text-3xl font-comfortaa font-bold text-white">Project Deep Dive</h3>
            </div>
            
            <div className="w-full h-px bg-white/5 mb-12"></div>
            
            <div className="max-w-4xl text-gray-400 leading-[2] text-lg font-poppins">
              <p className="mb-10 first-letter:text-5xl first-letter:font-bold first-letter:text-adaptiv-orange first-letter:mr-3 first-letter:float-left">
              ...
              <div className="bg-white/[0.02] border-l-4 border-adaptiv-orange p-8 rounded-r-3xl mb-12">
