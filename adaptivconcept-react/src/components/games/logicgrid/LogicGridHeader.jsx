...
const LogicGridHeader = ({ currentLevelIndex, totalLevels, levels, onOpenAuth, onOpenSettings }) => {
  ...
  return (
    <div className="flex items-center justify-between mb-8 relative z-10 flex-wrap gap-4 select-none">
      ...
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-sm font-bold font-comfortaa text-[#00f2ff] flex items-center gap-2">
          LogicGrid Solver Console
        </h2>
      </div>
      ...
      <div className="flex items-center gap-6">
                ...
                backgroundColor:
                  i === currentLevelIndex
                    ...
                    : i < currentLevelIndex
                      ? "var(--theme-color)"
                      : "var(--glass-border)",
                boxShadow: i === currentLevelIndex ? "0 0 10px #00f2ff" : "none",
              }}
            />
          ))}
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2 rounded-xl bg-white/5 border border-white/10 text-low hover:text-[#00f2ff] hover:border-[#00f2ff]/30 transition-all"
...
export default LogicGridHeader;
